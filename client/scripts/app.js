...
var app = {
  ...
  send: function(message) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        app.fetch();
        console.log('THIS IS THE DATA FROM SEND', data);
      },
  ...
  fetch: function(animate) {
    $.ajax({
      ...
      success: function(data) {
        console.log('this was good', data);
        ...
        console.log('most recent!', mostRecentMessage);

        console.log('I am the ID!!!', mostRecentMessage.objectId);

        console.log('I am the LAST message!', app.lastMessageId);
